...
export default function Home() {
  return (
    ...
    >
      ...
      <div className="mb-8">
        <p className="subtitle-1">Simple website to render Harry Potter pages in the different data fetching mechanisms we can use in a NextJS Pages Router project</p>
      </div>
